using HelpDesk.Application.Interfaces.Persistence.DataServices.People.Queries;
using HelpDesk.Domain.Entities;

namespace HelpDesk.Infrastructure.Persistence.DataServices.People.Queries;
